...
app.get('/api', (req, res, err) => {
    ...
    <body style="font-family: Helvetica, Arial, Sans-Serif; padding: 70px">
        ...
        <code style="background: lightgrey"><a style="text-decoration: none" href=\"https://rescuealley.tech/api/lonlat/47.1232,6.123124+5.12313,4.2326\">https://rescuealley.tech/api/lonlat/47.1232,6.123124+5.12313,4.2326</a></code>
        <br>
        <p></p>
    </body>
    </html>`)
